...
namespace kim\present\writecheck\task;
...
class CheckUpdateAsyncTask extends AsyncTask{
	...
	private const RELEASE_URL = "https://api.github.com/repos/PresentKim/WriteCheck-PMMP/releases/latest";
	...
	public function __construct(){
		$this->cachePath = WriteCheck::getInstance()->getDataFolder() . ".latestCache";
	}
